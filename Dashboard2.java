...
public class Dashboard2 extends JFrame {
	...
	public Dashboard2(){
		...
		JButton btnNewCustomerForm = new JButton("SEARCH FLIGHTS");
		btnNewCustomerForm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				FlightInfo custom = new FlightInfo();
		...
		JButton btnNewButton_3 = new JButton("MY BOOKING"); 
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					//error ---------------------
					MyBooking customer = new MyBooking();

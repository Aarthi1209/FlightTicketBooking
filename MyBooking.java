...
private JTextField t1;
	 ...
	 * @throws SQLException 
	 */
	public MyBooking() throws SQLException {
		...
		contentPane.setLayout(null);
                 ...
                 JLabel lblTime = new JLabel("CustomerId :");
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String displayCustomersql = "select * from booking where customerid = '"+t1.getText()+"'";
		...
		lblId.setBounds(31, 31, 46, 14);
		contentPane.add(lblId);
                
                JLabel l1 = new JLabel("CustomerId");
		l1.setBounds(150, 31, 46, 14);
		contentPane.add(l1);
		
		lblNewLabel = new JLabel("FlightNumber");
		lblNewLabel.setBounds(270, 31, 65, 14);
		contentPane.add(lblNewLabel);
		
		lblGender = new JLabel("Arrival");
		lblGender.setBounds(360, 31, 46, 14);
		contentPane.add(lblGender);
		
		table = new JTable();
		table.setBounds(0, 70, 900, 450);
		contentPane.add(table);
		
		lblCountry = new JLabel("Depature");
		lblCountry.setBounds(480, 31, 46, 14);
		contentPane.add(lblCountry);
		
		lblRoom = new JLabel("Time");
		lblRoom.setBounds(600, 31, 46, 14);
		contentPane.add(lblRoom);
		
		lblStatus = new JLabel("Date");
		lblStatus.setBounds(680, 31, 100, 14);
		contentPane.add(lblStatus);
		
		lblNewLabel_1 = new JLabel("Price");
		lblNewLabel_1.setBounds(800, 31, 100, 14);
